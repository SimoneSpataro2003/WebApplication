...
ON CONFLICT (id) DO UPDATE SET txt = EXCLUDED.txt;
    ...
    @Override
    public void addRistoranteToPiatto(String piattoNome, String ristoranteNome) {
    ...
    @Override
    public void removeRistoranteFromPiatto(String piattoNome, String ristoranteNome) {
